...
from third_party.rolling_forcing.modeling.rolling_forcing_inference import CausalInferencePipeline
from third_party.rolling_forcing.modeling.memory import DynamicSwapInstaller, get_cuda_free_memory_gb
...
default_config = OmegaConf.load("third_party/rolling_forcing/configs/default_config.yaml")
...
if hasattr(config, "checkpoint_path") and config.checkpoint_path:
    ...
    state_dict_to_load = state_dict["generator_ema" if config.use_ema else "generator"]
    pipeline.generator.load_state_dict(remove_fsdp_prefix(state_dict_to_load))

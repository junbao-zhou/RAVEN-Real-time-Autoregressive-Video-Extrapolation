...
from third_party.longlive.modeling.wan_wrapper import WanDiffusionWrapper, WanTextEncoder, WanVAEWrapper

from third_party.longlive.modeling.memory import gpu, get_cuda_free_memory_gb, DynamicSwapInstaller, move_model_to_device_with_memory_preservation, log_gpu_memory
...
class CausalInferencePipeline(torch.nn.Module):
    def __init__(
        ...
        self.generator = WanDiffusionWrapper(model_name=args.model_name,
            **getattr(args, "model_kwargs", {}), is_causal=True) if generator is None else generator
        self.text_encoder = WanTextEncoder(args.model_name) if text_encoder is None else text_encoder
        self.vae = WanVAEWrapper(args.model_name) if vae is None else vae
            ...
            for index, current_timestep in enumerate(self.denoising_step_list):
                ...
                if index < len(self.denoising_step_list) - 1:
                    ...
                    noisy_input = self.scheduler.add_noise(
                        ...
                        torch.empty_like(denoised_pred.flatten(0, 1)).normal_(generator=rng),

...
from third_party.causvid.modeling.wan_wrapper import CausalWanDiffusionWrapper, WanTextEncoder, WanVAEWrapper
...
class InferencePipeline(torch.nn.Module):
    def __init__(self, args, device):
        ...
        self.generator = get_diffusion_wrapper(
            model_name=self.generator_model_name)(args.model_path)
        self.text_encoder = get_text_encoder_wrapper(
            model_name=self.generator_model_name)(args.model_path)
        self.vae = get_vae_wrapper(model_name=self.generator_model_name)(args.model_path)
    ...
    def inference(self, noise: torch.Tensor, text_prompts: List[str], start_latents: Optional[torch.Tensor] = None, return_latents: bool = False,
            ...
            for index, current_timestep in enumerate(self.denoising_step_list):
                ...
                if index < len(self.denoising_step_list) - 1:
                    ...
                    noisy_input = self.scheduler.add_noise(
                        ...
                        next_timestep *
                        torch.ones([batch_size * self.num_frame_per_block], device="cuda",
                                   dtype=torch.long)
